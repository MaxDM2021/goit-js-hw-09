...
const options = {
    ...
    onClose (selectedDates) {
        if (selectedDates[0] < currentDate) (0, _notiflixDefault.default).Notify.warning("Please choose a date in the future!");
        choseDate = selectedDates[0];
        refs.startBtn.removeAttribute("disabled", true);
        refs.startBtn.addEventListener("click", timer.start.bind(timer));
    }
};
(0, _flatpickrDefault.default)(refs.flatpickrSelect, options);
class Timer {
    constructor({ onTick  }){
